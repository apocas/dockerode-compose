      ...
      for (var port of service.ports) {
        ...
        if (port_split.length == 2) {
          ...
          if (port_split[1].includes('-')) {
            ...
            for (let i = split_port_split0[0]; i <= split_port_split0[1]; i++) {
              split_port_split0_array.push(i);
            }

            let split_port_split1 = port_split[1].split('-');
            let split_port_split1_array = [];
            for (let l = split_port_split1[0]; l <= split_port_split1[1]; l++) {
              split_port_split1_array.push(l);
            }
          ...
          if (port_split[2].includes('-')) {
            ...
            let split_port_split1 = port_split[1].split('-');
            let split_port_split1_array = [];
            for (let i = split_port_split1[0]; i <= split_port_split1[1]; i++) {
              split_port_split1_array.push(i);
            }

            let split_port_split2 = port_split[2].split('-');
            let split_port_split2_array = [];
            for (let l = split_port_split2[0]; l <= split_port_split2[1]; l++) {
              split_port_split2_array.push(l);
            }
